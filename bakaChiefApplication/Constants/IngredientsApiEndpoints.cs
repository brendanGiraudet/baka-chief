...
public static class IngredientsApiEndpoints
{
    ...
    public static string GetIngredientsByNamePathUrl(int top, int skip, string name) => $"{GetIngredientsPathUrl(top,skip)}&$filter=contains(tolower(name), '{name?.ToLower()}') eq true";
